...
class ProprietaireProfilScreen extends ConsumerWidget {
  const ProprietaireProfilScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final profileAsync = ref.watch(proprietaireProfileProvider);
      ...
      child: Column(
        children: [
          ...
          profileAsync.when(
            ...
            error: (e, _) => ErrorRetryWidget(message: e.toString(), onRetry: () => ref.invalidate(proprietaireProfileProvider)),
            data: (profile) {
              ...
              final adresse = profile['adresse'] ?? '';

              return Column(
                children: [
                  CircleAvatar(
                    radius: 44,
                    backgroundColor: AppColors.proprietaireColor,
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(color: AppColors.proprietaireColor.withOpacity(0.1), borderRadius: BorderRadius.circular(100)),
                    child: Text(role.toUpperCase(), style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: AppColors.proprietaireColor)),
                  ),
