...
class GestionnaireMessagesScreen extends ConsumerWidget {
  const GestionnaireMessagesScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final dataAsync = ref.watch(gestionnaireMessagesProvider);
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              IconButton(icon: const Icon(Icons.refresh, size: 20), onPressed: () => ref.invalidate(gestionnaireMessagesProvider)),
            ],
          ),
        ),
        Expanded(
          child: dataAsync.when(
            ...
            error: (e, _) => ErrorRetryWidget(message: e.toString(), onRetry: () => ref.invalidate(gestionnaireMessagesProvider)),
            data: (list) {
              ...
              return RefreshIndicator(
                onRefresh: () async => ref.invalidate(gestionnaireMessagesProvider),
                    ...
                    return Container(
                      ...
                      child: Row(
                        children: [
                          CircleAvatar(
                            radius: 20,
                            backgroundColor: AppColors.gestionnaireColor.withOpacity(0.1),
                            child: const Icon(Icons.chat_bubble_outline, size: 18, color: AppColors.gestionnaireColor),
                          ),
