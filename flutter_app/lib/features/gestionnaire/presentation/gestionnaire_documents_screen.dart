...
class GestionnaireDocumentsScreen extends ConsumerWidget {
  const GestionnaireDocumentsScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final dataAsync = ref.watch(gestionnaireDocumentsProvider);
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              IconButton(icon: const Icon(Icons.refresh, size: 20), onPressed: () => ref.invalidate(gestionnaireDocumentsProvider)),
            ],
          ),
        ),
        Expanded(
          child: dataAsync.when(
            ...
            error: (e, _) => ErrorRetryWidget(message: e.toString(), onRetry: () => ref.invalidate(gestionnaireDocumentsProvider)),
            data: (list) {
              ...
              return RefreshIndicator(
                onRefresh: () async => ref.invalidate(gestionnaireDocumentsProvider),
                    ...
                    return Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          IconButton(icon: const Icon(Icons.download_outlined, size: 20, color: AppColors.gestionnaireColor), onPressed: () {}),
                        ],
                      ),
                    );
                  },
